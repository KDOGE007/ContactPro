...
namespace ContactPro.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AppUserID,FirstName,LastName,BirthDate,Address1,Address2,City,State,PostalCode,EmailAddress,PhoneNumber,Creeated,ImageData,ImageType")] Contact contact)
        {
