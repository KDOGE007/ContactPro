...
namespace ContactPro.Controllers
{
    public class ContactsController : Controller
    {
        ...
        //inject the above variables so that all the database information can be use in this contorller.
        ...
        public IActionResult SearchContacts(string searchString)
        {
            ...
            ViewData["CatagoryId"] = new SelectList(appUser.Categories, "Id", "Name", 0);
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,Address1,Address2,City,State,PostalCode,EmailAddress,PhoneNumber,Created,ImageFile")] Contact contact, List<int> CategoryList)
        {
